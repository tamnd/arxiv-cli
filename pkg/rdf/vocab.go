...
var Mapping = []Row{
	...
	{What: "published_in", Kind: "predicate", Terms: []IRI{DCSource, SchemaIsPartOf}, Label: LabelTo, Evidence: "oai_dc dc:source"},
	{What: "has_doi", Kind: "predicate", Terms: []IRI{SchemaIdentifier}, Evidence: "citation_doi"},
	{What: "licensed_under", Kind: "predicate", Terms: []IRI{DCRights, SchemaLicense}, Label: LabelTo, Evidence: "oai_dc dc:rights"},
