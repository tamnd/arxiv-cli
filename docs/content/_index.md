...
heroLead: "A command line for arXiv. One pure-Go binary, no API key, output that pipes into the rest of your tools."
...
```bash
arxiv --help            # the command tree
arxiv version           # build info
```
