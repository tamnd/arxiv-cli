...
Most of these come down to network reality or how arxiv serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

arxiv rate-limits like any public site. arxiv already paces
...
Where a surface is gated, arxiv reads a cookie or token you supply
...
`arxiv`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what arxiv actually did
