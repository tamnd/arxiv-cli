...
func Root() *cobra.Command {
	app := &App{cfg: arxiv.DefaultConfig()}

	root := &cobra.Command{
		Use:   "arxiv",
		Short: "A command line for arXiv.",
		Long: `arxiv reads the arXiv Open Access API and turns preprint metadata into
clean structured records. No API key required. It returns papers as
...
func (a *App) setup() error {
	...
	a.client = arxiv.NewClient(a.cfg)
	return nil
}
